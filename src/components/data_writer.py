...
class DataWriter:
    ...
    def _prepare_dataframe(
        self, df: pd.DataFrame, add_metadata: bool = True, metadata: Optional[Dict[str, Any]] = None
    ) -> SparkDataFrame:
        """
        ...
        try:
            ...
            if self.add_timestamp:
                ...
                spark_df = spark_df.withColumn(
                    self.timestamp_column, to_utc_timestamp(current_timestamp(), self.timestamp_timezone)
                )
